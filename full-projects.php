...
$query = 'SELECT projects.id AS proID, title, portfolio_image, category_id, category, category.id, folder FROM projects, category WHERE projects.category_id = category.id AND category_id = :categoryId ORDER BY display_order ASC';
