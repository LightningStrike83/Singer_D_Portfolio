export function WTP() {
    ...
    function showAnswer() {
        ...
        console.log ("click")
        wtpBox.style.backgroundImage = "url(../Singer_D_Portfolio/images/WTP-images/background-2.gif)"
        answerArrow.style.display = "none"
        pokemonName.style.display = "flex"

        pokemonImage.src = "../Singer_D_Portfolio/images/WTP-images/reveal.png"
