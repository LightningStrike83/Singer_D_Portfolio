...
$stmt = $connection->prepare('SELECT projects.id, title, portfolio_image, category_id FROM projects WHERE projects.category_id = 1 ORDER BY category_id DESC LIMIT 9');
$stmt->execute();
